...
SetGoodsCaoZuo(nil,nil,"知识卷轴","Metadata/Items/Currency/CurrencyIdentification",nil,nil,nil,160)--够了就不捡了
...
SetJiaoYiGoods(nil,nil,nil,nil,"Silver Flask")--"噬燼甕 真銀藥劑"
