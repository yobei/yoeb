...
SetNeedSkillLineData(96,"鋼筋鐵骨,nil|持續時間延長輔助,nil|先祖衛士,nil|增加暴擊率輔助,nil|物品稀有度增幅輔助,nil|連鎖輔助,nil|冰霜之刃,nil|迴旋之刃,nil|憎恨,nil",nil,4,nil)
...
SetNeedSkillLineData(99,"爆裂陷阱,nil|迅速組裝輔助,nil|機率中毒輔助,nil",20,nil,nil)
...
SetAtuoChangeEquipData("暗影|野蛮人|决斗者|女巫|游侠|圣堂武僧","戒指|项链|腰带|鞋子|手套|衣服|头盔|箭袋","base_maximum_life",0.2)--生命
...
SetZhengTiColorVarData(2,0,3,1,nil,500,true)
SetZhengTiColorVarData(2,0,4,0,nil,450,true)
SetZhengTiColorVarData(2,0,2,2,nil,400,true)
...
SetTaskShengJiData("a9q2",nil,"2_9_1",66,true)--做 到風暴飛刃 的时候刷滲血水道到68级再进行下一任务
SetTaskShengJiData("a10q2",nil,"2_9_1",83,true)--做 到風暴飛刃 的时候刷滲血水道到68级再进行下一任务


SetTaskMiGongData("a8q1",nil,1)--大于等于a9q1级 做迷宫1
SetTaskMiGongData("a9q3",nil,2)--大于等于a10q1 做迷宫2
SetTaskMiGongDataByLv(73,3)--大于等于70级 做迷宫3
