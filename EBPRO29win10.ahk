...
delvt:=alls/dad
SetFormat, float, .0
allnow:="%E8%81%96("(Divine)")%E6%B7%B7("Chaos*(86400/alls)")%E6%94%B9("Alteration*(86400/alls)")%E5%8C%A0("Jeweller*(86400/alls)")%E5%B9%BB("Chromatic*(86400/alls)")%E8%AC%99("Regal*(86400/alls)")%E8%AC%99("errloop
IniRead,iotkey,%dir%\yoset.ini,set,iotkey
IniRead,iotname,%dir%\yoset.ini,set,iotname
IniRead,nob,%dir%\yoset.ini,set,nob

dayatxt=https://maker.ifttt.com/trigger/yolist/with/key/%iotkey%?value1=D%nob%&value2=%allnow%
...
dayatxt=https://maker.ifttt.com/trigger/yolist/with/key/%iotkey%?value1=E%nob%&value2=%nwotime%&value3=%TheDate%
WinHttp := ComObjCreate("MSXML2.XMLHTTP.6.0")
WinHttp.Open("GET", dayatxt, false)
WinHttp.Send()
}
...
{
seegod++
seegodall:=Round((seegod*100)/skin)
GuiControl,,seegod,%seegod%
GuiControl,,seegodalla,%seegodall%
seegodmap=0
}
}
}
...
GuiControl,,testalltwoc,%testalltwoc%
}
...
if(startname10!=startnameI10)
{
startnameI10:=startname10
skin++
GuiControl,,skin,%skin%
}
...
MouseGetPos,exbuttx,exbutty,win,class
