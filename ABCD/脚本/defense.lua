...
SetNeedSkillLineData(96,"堅定,nil|鋼筋鐵骨,nil|持續時間延長輔助,nil|增加暴擊率輔助,nil|物品稀有度增幅輔助,nil|連鎖輔助,nil|冰霜之刃,nil|憎恨,nil",nil,4,nil)
...
SetTaskShengJiData("a9q3",nil,"2_9_1",65,true)--做 到風暴飛刃 的时候刷滲血水道到68级再进行下一任务
SetTaskShengJiData("a10q2",nil,"2_9_1",80,true)--做 到風暴飛刃 的时候刷滲血水道到68级再进行下一任务

SetTaskMiGongData("a9q5",nil,1)--大于等于a9q1级 做迷宫1
