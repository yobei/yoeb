...
SetSaveIndex("生命药剂|魔力药剂|复合药剂|功能药剂|命运卡","1|2")
...
SetSaveIndex("主动技能宝石|辅助技能宝石|珠宝|地图碎片","2")
...
SetGoodsCaoZuo(nil,nil,"点金石","Metadata/Items/Currency/CurrencyUpgradeToRare",nil,nil,nil,20)
...
SetGoodsCaoZuo(nil,"3","束縛石","Metadata/Items/Currency/CurrencyUpgradeToRareAndSetSockets",nil,nil,nil,0)--束縛石
