...
SetDebuffSkill(nil,"minion_focus_fire",nil,"minion_focussed_fire_target","2|3")--亡印
...
SetUseTuTengData("holy_flame_totem","Metadata/Monsters/Totems/HolyFireSprayTotem")--圣焰图腾
...
AddUseSkillData(2,"坚决战吼","enduring_cry",nil,nil,function(sk,me)local hpf=me.hp/me.maxHp;local needUse=hpf<0.8;MYTRACE1("-----------------hpf:%g needUse:%s",hpf,tostring(needUse))return needUse --[[me.hp/me.maxHp<0.7]] end)
