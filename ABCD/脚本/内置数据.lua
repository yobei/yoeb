...
SetUseTuTengData("shrapnel_ballista","Metadata/Monsters/Totems/ShotgunTotem")--散射驽炮
...
SetUseTuTengData("artillery_ballista","Metadata/Monsters/Totems/MortarTotem")--火力弩炮
SetUseTuTengData("holy_flame_totem","Metadata/Items/Gems/SkillGemFlameTotem")--火蛇圖騰

AddUseSkillData(1,"火力弩炮","artillery_ballista",nil,nil,nil,3,"2|3")
AddUseSkillData(1,"火力弩炮","artillery_ballista_totem",nil,nil,nil,3,"2|3")
AddUseSkillData(1,"攻城炮台","siege_ballista",nil,nil,nil,3,"2|3")
AddUseSkillData(1,"散射驽炮","shrapnel_ballista",nil,nil,nil,3,"2|3")
AddUseSkillData(1,"散射驽炮","shrapnel_ballista_totem",nil,nil,nil,3,"2|3")
...
--cdTime 使用间隔 单位为秒 支持小数 如果不填 或者 填nil为忽略，没有间隔
--monColor 字符串型 打什么颜色的怪物时使用 白怪为0 蓝怪为1 金怪为2 橙怪为3 (可支持多个，中间用|隔开) 填nil 或"0|1|2|3"为所有
...
SetGoodsCaoZuo("爪","0|1",nil,nil,nil,nil,nil,nil,"0|1|2",nil,nil,nil,true,nil,function(gd)return not g_setAllSkillGemOk end )--技能宝石未全部装备上就 拾取 出售蓝色 白色 黄色的三色相连装备
